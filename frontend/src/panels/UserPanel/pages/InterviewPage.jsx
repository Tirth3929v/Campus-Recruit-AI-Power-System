          ...
          >
            ...
            >
              ...
              <div className="relative z-10 text-center mb-8">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-indigo-500 to-teal-600 mb-6 shadow-lg shadow-indigo-500/30">
              ...
              <div className="relative z-10 grid grid-cols-2 gap-4 mb-8">
                ...
                <div className="bg-gray-800/50 rounded-xl p-4 text-center border border-gray-700">
                  ...
                  <div className={`text-xl font-bold ${
                    finalScoreData?.status === 'Outstanding' ? 'text-teal-400' :
              ...
              <button 
                ...
                className="relative z-10 w-full py-3.5 bg-gradient-to-r from-indigo-600 to-teal-600 hover:from-indigo-500 hover:to-teal-500 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/25 transition-all flex items-center justify-center gap-2"
              >
          ...
          <div className="relative z-10">
            <div className={`w-32 h-32 rounded-full flex items-center justify-center transition-all duration-500 ${isAiSpeaking ? 'shadow-[0_0_60px_rgba(99,102,241,0.5)] scale-105' : 'shadow-[0_0_20px_rgba(99,102,241,0.1)]'}`}>
              <div className="w-28 h-28 bg-gray-800 rounded-full flex items-center justify-center relative overflow-hidden border border-gray-700">
                <div className="absolute inset-0 bg-gradient-to-tr from-indigo-600/20 to-teal-600/20" />
                ...
                {isAiSpeaking && (
                  <>
                    ...
                    <div className="absolute inset-0 border-2 border-teal-500/30 rounded-full animate-ping delay-150" />
                  </>
                )}
              </div>
            </div>
