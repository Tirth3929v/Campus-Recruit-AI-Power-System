...
const DashboardLayout = () => {
  ...
  const navItems = [
    ...
    { path: '/courses', label: 'Courses', icon: Code },
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <header className="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-8 shadow-sm z-10">
          ...
          <div className="flex items-center gap-4">
             ...
             <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold shadow-lg ring-2 ring-white">
               SU
             </div>
          </div>
        </header>
