  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4 font-sans selection:bg-teal-500/30">
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-teal-900/20 blur-[120px]" />
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <input 
              type="text" id="name" name="name" required placeholder="Full Name" autoComplete="name"
          ...
          <div className="relative">
            ...
            <input 
              type="email" id="email" name="email" required placeholder="Email Address" autoComplete="email"
              className="w-full bg-gray-800/50 border border-gray-700 rounded-xl py-3 pl-10 pr-4 text-white focus:ring-2 focus:ring-teal-500 outline-none transition-all"
          ...
          <div className="relative">
            ...
            <input 
              type="password" id="password" name="password" required placeholder="Password" autoComplete="new-password"
              className="w-full bg-gray-800/50 border border-gray-700 rounded-xl py-3 pl-10 pr-4 text-white focus:ring-2 focus:ring-teal-500 outline-none transition-all"
          ...
          <div className="relative">
            ...
            <input 
              type="text" id="course" name="course" required placeholder="Course / Major" autoComplete="off"
              className="w-full bg-gray-800/50 border border-gray-700 rounded-xl py-3 pl-10 pr-4 text-white focus:ring-2 focus:ring-teal-500 outline-none transition-all"
          ...
          <div className="flex items-center gap-2">
            <input aria-label="Input field"  
              ...
              name="termsAccepted"
              id="terms"
              className="w-4 h-4 rounded border-gray-700 bg-gray-800 text-teal-600 focus:ring-teal-500 focus:ring-offset-gray-900 cursor-pointer"
              checked={formData.termsAccepted}
              onChange={(e) => setFormData({...formData, termsAccepted: e.target.checked})}
            />
            <label htmlFor="terms" className="text-xs text-gray-400 cursor-pointer select-none">I agree to the <span className="text-teal-400 hover:text-teal-300 transition-colors">Terms and Conditions</span></label>
          </div>
