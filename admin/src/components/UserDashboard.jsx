    ...
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'} transition-colors duration-300 font-sans`}>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <motion.div 
          ...
          className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-teal-900/50 to-blue-900/50 border border-white/10 p-8 md:p-12"
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl">
              You're making great progress. You are <span className="text-white font-bold">{progress}%</span> through <span className="text-teal-400">Advanced React Patterns</span>. Keep it up!
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <QuickAccessCard to="/interview" icon={<Bot size={24} className="text-teal-400" />} title="AI Interview Room" desc="Practice with AI Coach" color="bg-teal-500/10 border-teal-500/20" />
