      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <input 
              ...
              className={`w-full bg-gray-100 dark:bg-gray-800/50 border ${errors.name ? 'border-red-500' : 'border-gray-200 dark:border-gray-700'} rounded-xl py-3 pl-10 pr-4 text-gray-900 dark:text-white focus:ring-2 ${errors.name ? 'focus:ring-red-500' : 'focus:ring-teal-500'} outline-none transition-all`}
              value={formData.name} 
          ...
          <div className="relative">
            ...
            <input 
              ...
              className={`w-full bg-gray-100 dark:bg-gray-800/50 border ${errors.email ? 'border-red-500' : 'border-gray-200 dark:border-gray-700'} rounded-xl py-3 pl-10 pr-4 text-gray-900 dark:text-white focus:ring-2 ${errors.email ? 'focus:ring-red-500' : 'focus:ring-teal-500'} outline-none transition-all`}
          ...
          <div className="relative">
            ...
            <input 
              ...
              className={`w-full bg-gray-100 dark:bg-gray-800/50 border ${errors.password ? 'border-red-500' : 'border-gray-200 dark:border-gray-700'} rounded-xl py-3 pl-10 pr-4 text-gray-900 dark:text-white focus:ring-2 ${errors.password ? 'focus:ring-red-500' : 'focus:ring-teal-500'} outline-none transition-all`}
          ...
          <div className="relative">
            ...
            <select 
              required
              className={`w-full bg-gray-100 dark:bg-gray-800/50 border ${errors.course ? 'border-red-500' : 'border-gray-200 dark:border-gray-700'} rounded-xl py-3 pl-10 pr-4 text-gray-900 dark:text-white focus:ring-2 ${errors.course ? 'focus:ring-red-500' : 'focus:ring-teal-500'} outline-none transition-all appearance-none`}
          ...
          <div className="flex items-center gap-2">
            <input aria-label="Input field"  
              type="checkbox" 
              id="terms"
              className="w-4 h-4 rounded border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-teal-600 focus:ring-teal-500 focus:ring-offset-white dark:focus:ring-offset-gray-900 cursor-pointer"
              checked={formData.termsAccepted}
              onChange={(e) => setFormData({...formData, termsAccepted: e.target.checked})}
            />
            <label htmlFor="terms" className="text-xs text-gray-600 dark:text-gray-400 cursor-pointer select-none">I agree to the <span className="text-teal-600 dark:text-teal-400 hover:text-teal-500 transition-colors">Terms and Conditions</span></label>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            Already have an account? <Link to="/login" className="text-teal-600 dark:text-teal-400 hover:text-teal-500 font-bold transition-colors">Sign In</Link>
          </p>
        </div>
      </motion.div>
    </div>
