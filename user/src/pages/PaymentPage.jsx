...
const PaymentPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-gray-200 p-4 md:p-8 font-sans transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="glass-panel rounded-2xl p-6 md:p-8 shadow-sm sticky top-8">
              <h2 className="text-xl font-bold mb-6 text-white">Order Summary</h2>

              <div className="flex gap-4 mb-6">
                <div className="w-20 h-20 rounded-lg bg-black/40 overflow-hidden border border-white/10">
                  <img
                ...
                <div>
                  <h3 className="font-bold text-sm text-white line-clamp-2 mb-1">Advanced React Patterns</h3>
              ...
              <div className="space-y-3 border-t border-white/10 pt-4 mb-6">
                ...
                <div className="flex justify-between text-lg font-bold pt-2 border-t border-white/10 text-white">
                  <span>Total</span>
                  <span>$49.99</span>
                </div>
              </div>
