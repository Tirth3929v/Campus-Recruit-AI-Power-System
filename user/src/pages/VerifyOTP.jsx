          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-gray-100 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl py-4 px-4 text-gray-900 dark:text-white text-center text-2xl tracking-[12px] font-mono focus:ring-2 focus:ring-purple-500 outline-none transition-all"
                value={otp}
            ...
            <div className="text-center">
              ...
              <button 
                ...
                className="text-purple-600 dark:text-purple-400 hover:text-purple-500 font-bold text-sm transition-colors disabled:opacity-50 flex items-center justify-center gap-2 mx-auto"
              >
