  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-[#0B0F19] font-sans text-gray-900 dark:text-white overflow-hidden">
      ...
      <motion.aside
        ...
        className="bg-white dark:bg-slate-900 text-gray-900 dark:text-white flex flex-col shadow-xl dark:shadow-2xl z-30 h-full flex-shrink-0 overflow-hidden relative"
      >
        ...
        {/* ── Brand ──────────────────────────────────── */}
        <div className="h-20 flex items-center px-5 border-b border-gray-200 dark:border-slate-800/80 relative z-10">
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link key={item.path} to={item.path} className="relative block group">
                ...
                {!isSidebarOpen && (
                  <div className="absolute left-full top-1/2 -translate-y-1/2 ml-3 px-3 py-1.5 bg-gray-800 dark:bg-slate-800 text-white text-xs font-medium rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50 shadow-xl transition-opacity duration-200"
        ...
        {/* ── Logout ─────────────────────────────────── */}
        <div className="p-3 border-t border-gray-200 dark:border-slate-800/80 relative z-10">
          <button onClick={handleLogout}
            className="flex items-center gap-3 px-3 py-3 w-full text-gray-600 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-xl transition-all duration-300 group">
